...
# Define the dates for the 2 scenarios
...
# Create the observations dataframes
...
ax[0].plot(df_betaV.index.values, df_betaV["median"], color='k')
ax[0].fill_between(df_betaV.index.values, df_betaV["high_95"], df_betaV["low_95"], color='c', alpha=0.3)
ax[0].fill_between(df_betaV.index.values, df_betaV["high_50"], df_betaV["low_50"], color='b', alpha=0.3)
...
ax[1].plot(df_alphaV.index.values, df_alphaV["median"], color='k')
ax[1].fill_between(df_alphaV.index.values, df_alphaV["high_95"], df_alphaV["low_95"], color='c', alpha=0.3)
ax[1].fill_between(df_alphaV.index.values, df_alphaV["high_50"], df_alphaV["low_50"], color='b', alpha=0.3)
...
# Extract the fitting predictions
...
# Create the predictions dataframes
...
ax[0,0].plot(df_confirmedV.index.values, df_confirmedV["median"], color='gray')
ax[0,0].fill_between(df_confirmedV.index.values, df_confirmedV["high_95"], df_confirmedV["low_95"], color='cyan', alpha=0.3)
ax[0,0].fill_between(df_confirmedV.index.values, df_confirmedV["high_50"], df_confirmedV["low_50"], color='blue', alpha=0.3)
ax[0,0].scatter(obs_dfV.index.values, obs_dfV["smoothed_I_NV+PD"], edgecolors="w", facecolor="darkred")

ax[0,0].plot(df_confirmed.index.values, df_confirmed["median"], color='gray')
ax[0,0].fill_between(df_confirmed.index.values, df_confirmed["high_95"], df_confirmed["low_95"], color='cyan', alpha=0.3)
ax[0,0].fill_between(df_confirmed.index.values, df_confirmed["high_50"], df_confirmed["low_50"], color='blue', alpha=0.3)
...
ax[0,1].fill_between(df_deathsV.index.values, df_deathsV["high_95"], df_deathsV["low_95"], color='cyan', alpha=0.3)
ax[0,1].fill_between(df_deathsV.index.values, df_deathsV["high_50"], df_deathsV["low_50"], color='blue', alpha=0.3)
ax[0,1].scatter(obs_dfV.index.values, obs_dfV["smoothed_M_NV+PD"], edgecolors="w", facecolor="darkred")

ax[0,1].plot(df_deaths.index.values, df_deaths["median"], color='gray')
ax[0,1].fill_between(df_deaths.index.values, df_deaths["high_95"], df_deaths["low_95"], color='cyan', alpha=0.3)
ax[0,1].fill_between(df_deaths.index.values, df_deaths["high_50"], df_deaths["low_50"], color='blue', alpha=0.3)
ax[0,1].scatter(obs_df.index.values, obs_df["smoothed_MuertesNoVacunados"], edgecolors="w", facecolor="darkred")

ax[1,0].plot(df_confirmedVV.index.values, df_confirmedVV["median"], color='gray')
ax[1,0].fill_between(df_confirmedVV.index.values, df_confirmedVV["high_95"], df_confirmedVV["low_95"], color='cyan', alpha=0.3)
ax[1,0].fill_between(df_confirmedVV.index.values, df_confirmedVV["high_50"], df_confirmedVV["low_50"], color='blue', alpha=0.3)
...
# Create the dataframe for each state variable and plot it
...
C_time = np.mean(x_post_all[6,:,:,:], -1)
D_time = np.mean(x_post_all[7,:,:,:], -1)
...
ax[0,0].plot(df_S.index.values, df_S["median"], color='k')
ax[0,0].fill_between(df_S.index.values, df_S["high_95"], df_S["low_95"], color='k', alpha=0.3)
ax[0,0].fill_between(df_S.index.values, df_S["high_50"], df_S["low_50"], color='k', alpha=0.3)

ax[0,1].plot(df_E.index.values, df_E["median"], color='k')
ax[0,1].fill_between(df_E.index.values, df_E["high_95"], df_E["low_95"], color='k', alpha=0.3)
ax[0,1].fill_between(df_E.index.values, df_E["high_50"], df_E["low_50"], color='k', alpha=0.3)
...
ax[1,0].plot(df_Iu.index.values, df_Iu["median"], color='k')
ax[1,0].fill_between(df_Iu.index.values, df_Iu["high_95"], df_Iu["low_95"], color='k', alpha=0.3)
ax[1,0].fill_between(df_Iu.index.values, df_Iu["high_50"], df_Iu["low_50"], color='k', alpha=0.3)

ax[1,1].plot(df_Ih.index.values, df_Ih["median"], color='k')
ax[1,1].fill_between(df_Ih.index.values, df_Ih["high_95"], df_Ih["low_95"], color='k', alpha=0.3)
ax[1,1].fill_between(df_Ih.index.values, df_Ih["high_50"], df_Ih["low_50"], color='k', alpha=0.3)

ax[1,2].plot(df_R.index.values, df_R["median"], color='k')
ax[1,2].fill_between(df_R.index.values, df_R["high_95"], df_R["low_95"], color='k', alpha=0.3)
ax[1,2].fill_between(df_R.index.values, df_R["high_50"], df_R["low_50"], color='k', alpha=0.3)


S_time = np.mean(x_post_allV[0,:,:228,:], -1)
E_time = np.mean(x_post_allV[1,:,:228,:], -1)
Ir_time = np.mean(x_post_allV[2,:,:228,:], -1)
Iu_time = np.mean(x_post_allV[3,:,:228,:], -1)
Ih_time = np.mean(x_post_allV[4,:,:228,:], -1)
R_time = np.mean(x_post_allV[5,:,:228,:], -1)
C_time = np.mean(x_post_allV[6,:,:228,:], -1)
D_time = np.mean(x_post_allV[7,:,:228,:], -1)
...
ax[0,2].plot(df_Ir.index.values, df_Ir["median"], color='k')
ax[0,2].fill_between(df_Ir.index.values, df_Ir["high_95"], df_Ir["low_95"], color='k', alpha=0.3)
ax[0,2].fill_between(df_Ir.index.values, df_Ir["high_50"], df_Ir["low_50"], color='k', alpha=0.3)
...
for axi in ax.flatten():
  ...
  axi.set_xlabel("Date", fontsize=15)
  axi.set_ylabel("Exposed", fontsize=15)
  axi.set_title("ExposedV", fontsize=15)
...
S_time = np.mean(x_post_allV[8,:,:228,:], -1)
E_time = np.mean(x_post_allV[9,:,:228,:], -1)
Ir_time = np.mean(x_post_allV[10,:,:228,:], -1)
Iu_time = np.mean(x_post_allV[11,:,:228,:], -1)
Ih_time = np.mean(x_post_allV[12,:,:228,:], -1)
R_time = np.mean(x_post_allV[13,:,:228,:], -1)
C_time = np.mean(x_post_allV[14,:,:228,:], -1)
D_time = np.mean(x_post_allV[15,:,:228,:], -1)
...
ax[0,0].plot(df_S.index.values, df_S["median"], color='b')
ax[0,0].fill_between(df_S.index.values, df_S["high_95"], df_S["low_95"], color='b', alpha=0.3)
ax[0,0].fill_between(df_S.index.values, df_S["high_50"], df_S["low_50"], color='b', alpha=0.3)

ax[0,1].plot(df_E.index.values, df_E["median"], color='b')
ax[0,1].fill_between(df_E.index.values, df_E["high_95"], df_E["low_95"], color='b', alpha=0.3)
ax[0,1].fill_between(df_E.index.values, df_E["high_50"], df_E["low_50"], color='b', alpha=0.3)

ax[0,2].plot(df_Ir.index.values, df_Ir["median"], color='b', label='Median vaccinated')
ax[0,2].fill_between(df_Ir.index.values, df_Ir["high_95"], df_Ir["low_95"], color='b', alpha=0.3)#)
ax[0,2].fill_between(df_Ir.index.values, df_Ir["high_50"], df_Ir["low_50"], color='b', alpha=0.3)#)

ax[1,0].plot(df_Iu.index.values, df_Iu["median"], color='b')
ax[1,0].fill_between(df_Iu.index.values, df_Iu["high_95"], df_Iu["low_95"], color='b', alpha=0.3)
ax[1,0].fill_between(df_Iu.index.values, df_Iu["high_50"], df_Iu["low_50"], color='b', alpha=0.3)

ax[1,1].plot(df_Ih.index.values, df_Ih["median"], color='b')
ax[1,1].fill_between(df_Ih.index.values, df_Ih["high_95"], df_Ih["low_95"], color='b', alpha=0.3)
ax[1,1].fill_between(df_Ih.index.values, df_Ih["high_50"], df_Ih["low_50"], color='b', alpha=0.3)

ax[1,2].plot(df_R.index.values, df_R["median"], color='b')
ax[1,2].fill_between(df_R.index.values, df_R["high_95"], df_R["low_95"], color='b', alpha=0.3)
ax[1,2].fill_between(df_R.index.values, df_R["high_50"], df_R["low_50"], color='b', alpha=0.3)
